...
def app():
     ...
     if uploaded_file is not None:
          ...
          data.to_csv(r'data/main_data.csv', index=False) #considering this is a multiapp, this was my go to method to carry the dataset to the other pages (by thus saving the file into a csv that is then saved in the folder)
     else:
          data = ""
